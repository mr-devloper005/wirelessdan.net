export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'wirelessdan',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Wirelessdan',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'wirelessdan.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://wirelessdan.net',
